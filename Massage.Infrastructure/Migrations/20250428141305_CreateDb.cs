        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpecialDates_ProviderSchedules_ProviderScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeSlots_ProviderSchedules_ProviderScheduleId",
                        column: x => x.ProviderScheduleId,
                        principalTable: "ProviderSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkingHours_ProviderSchedules_ProviderScheduleId",
                        column: x => x.ProviderScheduleId,
                        principalTable: "ProviderSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialDates_ProviderScheduleId_Date",
                table: "SpecialDates",
                columns: new[] { "ProviderScheduleId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimeSlots_ProviderScheduleId_StartTime_EndTime",
                table: "TimeSlots",
                columns: new[] { "ProviderScheduleId", "StartTime", "EndTime" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingHours_ProviderScheduleId_DayOfWeek",
                table: "WorkingHours",
                columns: new[] { "ProviderScheduleId", "DayOfWeek" },
                unique: true);
        }
